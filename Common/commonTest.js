...
const CaNode = require(`./lib/CaNode`);
...
let caNode = new CaNode("testUser", "testUserpw", "7952", "Org1", true, "0.0.0.0,*.Org1.com");
console.log(JSON.stringify(caNode.generateDockerConfiguration()));