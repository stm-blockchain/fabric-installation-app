...
http://172.19.34.86:5000/initOrderer
...
http://172.19.34.86:5000/initPeer
...
cp $HOME/fabric-2.3-example/javascript@0.0.1.tar.gz $HOME/ttz/chaincodes
...
http://172.19.34.86:5000/joinChannel
...
http://172.19.34.86:5000/prepareCommit
...
http://localhost:5000/commitChaincode
